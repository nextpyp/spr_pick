...
class DualNetworkShallower(nn.Module):
    def __init__(
        self,
        in_channels: int = 1,
        out_channels: int = 1,
        ...
        super(DualNetworkShallower, self).__init__()
    ...
    def forward(self, x: Tensor):
        ...
        encoded = self.encode_block_6(pool2)
        ...
        concat3 = torch.cat((upsample5, pool1), dim=1)
        # print('concat5')
        print(concat3.shape)
        ...
        # print
        upsample1 = self.decode_block_2(concat3)
